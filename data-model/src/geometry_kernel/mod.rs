...
pub struct Reference {
    ///The object that owns this reference
    pub self_id: RefID,
    ///The geometry that will be updated by this reference
    pub self_index: ResultInd,
    ///The object this reference is pointing to
    pub other_id: RefID,
    ///The geometry this reference is pointing to
    pub other_index: ResultInd,
}
